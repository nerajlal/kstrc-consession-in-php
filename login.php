                    ...
                    <div class="row g-0">
                        <div class="col-lg-12 wow fadeIn" data-wow-delay="0.1s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <p class="mb-4">If you haven't an account. <a href="sreg.php">Register</a>.</p>
                               	<form action="check.php" method="POST">
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" name="username" class="form-control border-0" id="name" placeholder="Your Name" required>
