        ...
        <        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Our Baby Sitters</h1>
              ...
              $result = mysql_query("SELECT * FROM table_sitterreg where s_sts='1'");
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="../<?php echo $row['profile_pic'];?>" alt="">
                            <div class="team-text">
