    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Conductor Registration</h1>
                            ...
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <form action="" method="POST" >
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="name" name="fname" placeholder="Your Name" 
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="name" name="address" placeholder="Your Name" 
										...
										<div class="col-sm-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control border-0" id="phno" name="phone" placeholder="Mobile Number" 
...
if(isset($_POST['submit']))
{
    ...
    if($flag==0)
           {
            $sql="INSERT INTO condreg VALUES ('null','$fname','$address','$phone','$email','$password')";
            echo $sql;
            mysql_query($sql);
			$sql="INSERT INTO login VALUES ('null','$fname','$password','transport','1')";
            echo $sql;
            mysql_query($sql);
